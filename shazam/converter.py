...
from shazam.algorithm import SignatureGenerator
from shazam.client import HTTPClient
from shazam.exceptions import BadCityName, BadCountryName
from shazam.models import *
